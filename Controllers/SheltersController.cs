...
namespace modelMVC.Controllers
{
    public class SheltersController : Controller
    {
        ...
        public SheltersController(AdoptBuddyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,PhoneNumber")] Shelter shelter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,PhoneNumber")] Shelter shelter)
        {
            if (id != shelter.Id)
            {
                return NotFound();
